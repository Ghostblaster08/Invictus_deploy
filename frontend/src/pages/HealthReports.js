...
const HealthReports = () => {
  ...
  useEffect(() => {
    const updateData = () => {
      ...
      setChartData([
        { name: "Taken", count: takenCount },
        { name: "Missed", count: missedMeds.length },
      ]);
  ...
  const healthData = [
    { name: "Taken", value: healthScore },
    { name: "Missed", value: 100 - healthScore },
  ];
  ...
  return (
    <div className="health-reports-container">
      ...
      <div className="card health-score-card">
        ...
        <p className="health-score-text">{healthScore}% Adherence</p>
      </div>
